...
| Ratings & Models | Model methodology | What assumptions does Equelo make, and what did the experiments teach? | Research | Prototype | Medium | `docs/What is an Equelo Rating.md`, Equelo code and outputs | Essay plus selected charts | The foundational essay now exists; selected evidence and public presentation still need integration. |
