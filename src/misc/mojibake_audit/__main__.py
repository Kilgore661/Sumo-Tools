"""Run the mojibake audit with ``python -m src.misc.mojibake_audit``."""
...
from src.misc.mojibake.audit import audit_tree
from src.misc.mojibake.findings import write_findings, write_summary
