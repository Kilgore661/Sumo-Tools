...
| Stress-test 7.1 Basho Results redesign | Open | The settled 7.1 record/context/analysis model is now specified in `02 Specification.md`, designed in `04.5 Basho Results Model.md`, and rendered in the transitional runtime. The remaining work is stress-testing and hardening: move compact-result and Analysis derivations toward producer/site-facing fields where appropriate, check in-progress and no-successor-banzuke cases, verify sorting on the new terminal paths, and decide how much transitional parsing may remain. |
...
Context, Skill, Analysis, Result and Comparison shape rendered by the
