...
Clickable Notes popovers are also complete as a runtime interaction. The
highest-risk remaining items are row-number/ranking policy, shikona Alt-click
behavior and the interim table-group/heading work. The current column-group work
is intentionally interim and ad hoc; it should not become the first step toward a
general table theory.
