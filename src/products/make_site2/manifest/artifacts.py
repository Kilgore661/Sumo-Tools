...
BANZUKE_CHANGES_ARTIFACT = BanzukeChangesArtifact(
    ...
    notes=(
        Note(id="note_result", applies_to=("context",), text="In Result, arrows show movement between rank groups such as Maegashira, Komusubi, Sekiwake, Ozeku, Yokozuna or the lower divisions. This differs from the movement column, which shows movement up or down in banzuke slot order."),
