...
### 5.4 Era Chart Migration

Completed 2026-05-15. Banzuke Division by Era and Makuuchi Rank by Era are
generated by repo Python as site-facing bundles and rendered by `make_site` as
PA-backed chart views.
