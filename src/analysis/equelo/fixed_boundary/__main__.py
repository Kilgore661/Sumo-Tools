"""Command-line entry point for the fixed-boundary Equelo experiment."""
...
from .producer import OUTPUT_ROOT, build_fixed_boundary


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build the experimental M/J-boundary Equelo producer.",
    )
    ...
    parser.add_argument(
        ...
        type=int,
        default=1989,
        help="First year included everywhere in the experiment (default: 1989).",
    )
    parser.add_argument(
        "--end-year",
        type=int,
        help="Optional final year; by default use all data from --start-year onward.",
    )
    return parser
