"""Read fixed_v2 Equelo rating artefacts."""
...
def load_entrant_initial_ratings(
    ...
    """Load fixed_v2 entrant initial ratings keyed by chii ordinal string."""
