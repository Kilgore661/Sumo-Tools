"""Command-line entry point for the Juryo--Makushita experiment."""
...
from .producer import OUTPUT_ROOT, build_fixed_jms_boundary


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Build the post-1988 Juryo--Makushita boundary experiment.",
    )
