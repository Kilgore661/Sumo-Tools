...
```text
files/output/makefile/sdda/{root-module}/
```
...
```powershell
python makefile/sdda.py src.infra.get_bios.__main__ --import-root .
python makefile/sdda.py src.infra.get_bios.parser --import-root .
python makefile/sdda.py src.products.make_site2.__main__ --import-root .
```
